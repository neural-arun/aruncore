...
export const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  return (
    <div className="flex h-full flex-col justify-start overflow-hidden bg-[var(--bg-main)]">
      {messages.length === 0 ? (
        /* Top-Aligned Continuous Block Mobile Landing Layout */
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          <div className="mx-auto max-w-4xl w-full flex flex-col gap-3.5 sm:gap-5 animate-fade-slide">
            ...
            {/* Chat Input Box (~56px height, sits at the bottom of the block) */}
